...
export default function Experience() {
  ...
  return (
    <div className="container py-12">
      ...
      >
        <h1 className="text-3xl md:text-4xl font-bold mb-4 bg-gradient-to-r from-white to-purple-400 bg-clip-text text-transparent">Experience</h1>
      ...
      >
        {data.experience.map((e,i)=>(
          ...
          >
            ...
            <motion.div className="text-lg mt-1 text-muted">{e.company}</motion.div>
